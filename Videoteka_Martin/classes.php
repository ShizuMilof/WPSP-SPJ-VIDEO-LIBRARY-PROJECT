...
class Film
{
    ...
    public function __construct($film_id, $film_sifra, $naziv, $opis, $status, $godina_izlaska, $trajanje, $poster,$zanr,$kolicina,$statistika)
    {
...
abstract class Osoba
{
    ...
    public function __construct($oib, $ime, $prezime, $spol, $datum_rod,$statistika)
    {
        $this->OIB = $oib;
        $this->Ime = $ime;
...
class Zapis
{
    ...
    public function __construct($id,$akcija, $ime, $prezime, $naziv, $vrijeme_izdavanja, $vrijeme_povrata)
    {
        $this->Id = $id;
        $this->Akcija = $akcija;
        $this->Ime = $ime;
